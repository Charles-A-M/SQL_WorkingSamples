...
/****** Object:  Job [Who Is Active?]    Script Date: 12/11/2018 4:23:31 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 12/11/2018 4:23:31 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Who Is Active?', 
		@enabled=1, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'-- https://www.brentozar.com/archive/2016/07/logging-activity-using-sp_whoisactive-take-2/', 
		@category_name=N'[Uncategorized (Local)]', 
		@owner_login_name=N'CODWTR\charles.moore', 
		@notify_email_operator_name=N'WIMS DBA Team', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Capture Data and Purge old data]    Script Date: 12/11/2018 4:23:32 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Capture Data and Purge old data', 
		@step_id=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Every 45 seconds', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=2, 
		...
		@active_start_time=2334, 
		@active_end_time=235959, 
		@schedule_uid=N'f0306afb-65f4-4d25-a9ff-7ffbabf46015'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
